...
<head>
    ...
    <script>
        ...
        function deleteVille(id) {
            var confirmation = confirm("Êtes-vous sûr de vouloir supprimer cette ville ?");
            if (confirmation) {
...
<body>
    ...
    <button onclick="toggleAddForm()" class="btn btn-success"><i class="fas fa-plus"></i> Ajouter</button>
